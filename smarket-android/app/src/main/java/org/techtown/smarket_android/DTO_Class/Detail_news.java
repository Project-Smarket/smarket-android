...
public class Detail_news implements Parcelable {
    ...
    public Detail_news(String newsImg, String newsTitle, String newsUrl, String newsUser, String newsHit, String newsDate){
    ...
    protected Detail_news(Parcel in){
        readFromParcel(in);
    }
    ...
    public static final Parcelable.Creator CREATOR = new Parcelable.Creator() {
        public Detail_news createFromParcel(Parcel in) {
            return new Detail_news(in);
        }

        public Detail_news[] newArray(int size) {
            return new Detail_news[size];
        }
    };
}
